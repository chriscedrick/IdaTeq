...
const Home = () =>{
    ...
    <div className="text-center lg:text-left bg-white">
        <div className="container p-7 ">
            <div className="grid grid-cols-2 gap-2 lg:gap-4 justify-center items-center lg:grid-cols-3">
                <div className="mb-4 lg:mb-0 text-end">
                    <p className="font-bold mb-4 uppercase text-4xl lg:text-4xl text-blue-800">
                        our mission
                    </p>
                </div>
                <div className="mb-4 lg:mb-0 lg:col-span-2 text-small lg:text-base text-start">
    ...
    <div className="relative bg-cover" style={{backgroundImage: `url(${homeback})`}}>
        <div className="mx-auto max-w-2xl py-2 px-4 sm:py-5 sm:px-6 lg:max-w-7xl lg:px-40">
            <h2 className="sr-only">Programs</h2>
            <h5 className="mb-2 text-3xl font-bold text-blue-800 uppercase text-center">Our ICT Informal Education Programs
            </h5>
            ...
            <div className="grid grid-cols-2 gap-y-4 gap-x-4 sm:grid-cols-2 lg:grid-cols-2 xl:grid-cols-2 xl:gap-x-5 lg:px-16">
                <div className="group aspect-w-1 aspect-h-1 overflow-hidden rounded-lg bg-white w-full xl:aspect-w-7 xl:aspect-h-8 animate__animated animate__backInLeft"
                    ...
                    <div className="items-center justify-center text-left px-6 py-6 sm:px-12 sm:py-10">
                        ...
                        <div className="font-sans text-sm font-medium mt-3 sm:mt-7 text-blue-800 underline"><Link to="/girls">Find
                                More</Link></div>
                    </div>
                </div>
                <div className="group aspect-w-1 aspect-h-1 w-full overflow-hidden rounded-lg bg-white xl:aspect-w-7 xl:aspect-h-8 animate__animated animate__backInRight"
                    ...
                    <div className="items-center justify-center text-left px-6 py-6 sm:px-12 sm:py-10">
                        ...
                        <div className="font-sans text-sm font-medium mt-3 sm:mt-7 text-blue-800 underline"><Link to="">Find
                                More</Link></div>
                    </div>
                </div>
                <div className="group aspect-w-1 aspect-h-1 overflow-hidden rounded-lg bg-white w-full xl:aspect-w-7 xl:aspect-h-8 animate__animated animate__backInUp"
                    ...
                    <div className="items-center justify-center text-left px-6 py-6 sm:px-12 sm:py-10">
                        ...
                        <div className="text-2xl font-bold uppercase mb-3 sm:text-3xl text-blue-800">Junior programMERS
                        </div>
                        ...
                        <div className="font-sans text-sm font-medium mt-3 sm:mt-7 text-blue-800 underline"><Link to="/juniors">Find
                                More</Link></div>
                    </div>
                </div>
                <div className="group aspect-w-1 aspect-h-1 overflow-hidden rounded-lg bg-white w-full xl:aspect-w-7 xl:aspect-h-8 animate__animated animate__backInUp"
